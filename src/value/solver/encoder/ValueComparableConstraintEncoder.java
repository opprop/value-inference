...
public class ValueComparableConstraintEncoder extends ValueAbstractConstraintEncoder
    ...
    protected BoolExpr encode(ComparableOperationKind operation, Slot first, Slot second) {
    ...
    @Override
    public BoolExpr encodeVariable_Variable(ComparableOperationKind operation, Slot fst, Slot snd) {
        return encode(operation, fst, snd);
    }

    @Override
    public BoolExpr encodeVariable_Constant(
            ComparableOperationKind operation, Slot fst, ConstantSlot snd) {
        return encode(operation, fst, snd);
    }

    @Override
    public BoolExpr encodeConstant_Variable(
            ComparableOperationKind operation, ConstantSlot fst, Slot snd) {
        return encode(operation, fst, snd);
    }

    @Override
    public BoolExpr encodeConstant_Constant(
            ComparableOperationKind operation, ConstantSlot fst, ConstantSlot snd) {
        return encode(operation, fst, snd);
    }
}
