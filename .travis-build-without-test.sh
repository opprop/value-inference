...
if [ -d $ROOT/checker-framework ] ; then
    ...
    (cd $ROOT && git clone --depth 1 https://github.com/txiang61/checker-framework.git)
fi

# This also builds annotation-tools and jsr308-langtools
(cd $ROOT/checker-framework/ && ./.travis-build-without-test.sh downloadjdk && ./gradlew shadowJar)
...
if [ -d $ROOT/plume-lib ] ; then
    ...
    (cd $ROOT && git clone --depth 1 https://github.com/txiang61/plume-lib.git)
fi
